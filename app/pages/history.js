...
import {historyFetch} from "../store/history";
                ...
                <Content padder>
                    ...
                    {!this.histories().length && <View style={{marginHorizontal: 15}}>
                        <H1 allowFontScaling={false} style={[theme.h3, theme.centerAll, {fontSize: 30}]}>Você ainda não
                            efetuou nenhuma
                            transação!</H1>
                        <H1 allowFontScaling={false} style={[theme.h3, theme.centerAll]}>Deposite agora mesmo em sua
                            conta!</H1>
                    </View>}
                </Content>
                {!this.histories().length && <View style={[theme.fixBottom, theme.centerAll]}>
                    <TouchableOpacity
                        onPress={() => this.props.navigation.navigate('Receiver')}
                        disabled={this.state.loading}
                        style={[
                            this.state.loading ? theme.buttonDisabled : theme.buttonDark, theme.centerAll,
                            {marginTop: 30,}, {backgroundColor: darkButton,},
                        ]}
                    >
                        {this.state.loading && <ActivityIndicator
                            style={[theme.centerAll, {marginTop: 8}]}
    ...
    getIcon(id) {
        switch (id) {
            ...
            case 2:
                return <AntDesign name="arrowdown" size={28} color="green" />
            case 29:
                return <AntDesign name="creditcard" size={28} color="red" />
            case 30:
                return <AntDesign name="creditcard" size={28} color="green" />
            case 7:
