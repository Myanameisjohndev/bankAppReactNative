...
class FifthStep extends Component {
  ...
  takePicture = async () => {
    if (this.camera) {
      ...
      this.setState({document_back: data.base64});
    }
  };
        ...
        <Content style={{marginHorizontal: 5, marginTop: 60}} padder>
          <H1
            style={[
              theme.h3,
              theme.fontBold,
              {marginTop: 0, paddingTop: 10, fontSize: 35},
            ]}>
            Verso do documento
          </H1>
          {this.getCameraContent()}
          <View style={{paddingTop: '30%'}}>
            {!this.state.document_back && (
              <TouchableOpacity
            ...
            {this.state.document_back && (
              <View>
                <TouchableOpacity
                  ...
                  style={[theme.buttonDark, theme.centerAll, {marginTop: -80}]}>
                  <H3 style={[theme.centerAll, theme.h3_light]}>Ficou bom </H3>
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => this.setState({document_back: null})}
    ...
    if (this.state.document_back) {
      return (
        <ImageBackground
          ...
          source={{uri: 'data:image/png;base64,' + this.state.document_back}}
        />
      );
    }
    return (
      <RNCamera
        ...
        style={[
          {width: undefined, minHeight: 300, maxHeight: 200, marginTop: 150},
        ]}
