...
class Others extends Component {
  ...
  async shareFile(uri) {
    if (Platform.OS !== 'ios') {
      await Share.open({
        ...
        message: `Este é o meu comprovante ${json.name}! https://EsgBank.com`,
        url: uri,
      });
    } else {
      await Share.open({
  ...
  render() {
      ...
      <Container>
        ...
        <Content scrollEnabled={true} padder>
          <ViewShot
            ...
            <Text allowFontScaling={false} style={[theme.h3, {marginTop: -40}]}>
              {title}
            </Text>
            <Text
            ...
            <Text allowFontScaling={false} style={[theme.h3, {marginTop: 10}]}>
              Enviado de
            </Text>
            <Text
              allowFontScaling={false}
              style={[theme.h3, {color: '#000', fontSize: 20, marginTop: 0}]}>
              {Helpers.toTitleCase(dados.usuario_transacao.pessoa.nome)}
            </Text>
            <Text
              allowFontScaling={false}
    ...
    //                         editable={false}
    //                         style={[Style.inputSearch, {flex: 1}]}
    //                         value={dados.complementos.conta.toString().padStart(12, '0')}
    //                     />
    //                 </View>
